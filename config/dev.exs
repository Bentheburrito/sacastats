...
config :sacastats, SacaStatsWeb.Endpoint,
  ...
  check_origin: ["//*.lvh.me", "//localhost:4000"],
  ...
  watchers: [
    ...
    node: ["build-dev.js", "--watch", cd: Path.expand("../assets", __DIR__)]
  ]
...
config :sacastats, SacaStatsWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/sacastats_web/(live|views)/.*(ex)$",
      ~r"lib/sacastats_web/templates/.*(eex)$"
    ]
  ]
