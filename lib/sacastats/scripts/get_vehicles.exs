res = HTTPoison.get!("https://raw.githubusercontent.com/cooltrain7/Planetside-2-API-Tracker/master/Census/vehicle.json")
res_map = Jason.decode!(res.body)

cost_map = File.read!("./lib/sacastats/static_data/vehicle_cost_map.json") |> Jason.decode!()

vehicle_map = for vehicle <- res_map["vehicle_list"], into: %{} do
