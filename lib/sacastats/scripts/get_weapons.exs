res = HTTPoison.get!("https://raw.githubusercontent.com/cooltrain7/Planetside-2-API-Tracker/master/Weapons/sanction-list.csv")
[_headers | lines] = String.split(res.body, "\n")

weapon_map = for line <- lines, into: %{} do
